...
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-body">
                <div class="container float-right" style="position: fixed;z-index: 2;right: 44px;top: 60px;">
                   
                    <div class="circle">
                        <svg width="300" viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg">
                            <g transform="translate(110,110)">
                                <circle r="50" class="e-c-base" />
                                <g transform="rotate(-90)">
                                    <circle r="50" class="e-c-progress" />
                                    <g id="e-pointer">
                                        <circle cx="50" cy="0" r="8" class="e-c-pointer" />
                                    </g>
                                </g>
                            </g>
                        </svg>
